...
export const PAPER_CONTENT = {
  zh: {
    ...
    author: '于潇, 高震极 (2024)',
    summary:
      '研究显示东北人口负增长加速，劳动力规模至2050年可能缩减至1/3，老龄化程度远超全国平均水平。37个城市中34个在收缩。建议通过提升人口素质、完善生育支持和数字化农业来实现“以质代量”的振兴。',
    corePoints: [
  ...
  de: {
    ...
    summary:
      'Die Studie zeigt, dass sich der Bevölkerungsrückgang in Nordostchina beschleunigt. Die Erwerbsbevölkerung könnte bis 2050 auf ein Drittel schrumpfen. 34 von 37 Städten schrumpfen. Empfohlen wird eine qualitative Entwicklung durch Bildung, Geburtenförderung und digitale Landwirtschaft.',
    corePoints: [
